! function(e) {
    ...
    function g(e) {
        return a(e) ? h : c(e) ? u : o(e) ? l : r ? h : s ? u : l
    }
    ...
    t.read = function(e, t, n, i, r) {
        var s, o, a = 8 * r - i - 1,
            ...
            f = n ? -1 : 1,
            d = e[t + u];
        for (u += f, s = d & (1 << -h) - 1, d >>= -h, h += a; h > 0; s = 256 * s + e[t + u], u += f, h -= 8);
        for (o = s & (1 << -h) - 1, s >>= -h, h += i; h > 0; o = 256 * o + e[t + u], u += f, h -= 8);
        if (0 === s) s = 1 - l;
        else {
        ...
        var o, a, c, l = 8 * s - r - 1,
            ...
            p = i ? 1 : -1,
            g = t < 0 || 0 === t && 1 / t < 0 ? 1 : 0;
        for (t = Math.abs(t), isNaN(t) || t === 1 / 0 ? (a = isNaN(t) ? 1 : 0, o = h) : (o = Math.floor(Math.log(t) / Math.LN2), t * (c = Math.pow(2, -o)) < 1 && (o--, c *= 2), (t += o + u >= 1 ? f / c : f * Math.pow(2, 1 - u)) * c >= 2 && (o++, c /= 2), o + u >= h ? (a = 0, o = h) : o + u >= 1 ? (a = (t * c - 1) * Math.pow(2, r), o += u) : (a = t * Math.pow(2, u - 1) * Math.pow(2, r), o = 0)); r >= 8; e[n + d] = 255 & a, d += p, a /= 256, r -= 8);
        for (o = o << r | a, l += r; l > 0; e[n + d] = 255 & o, d += p, o /= 256, l -= 8);
        e[n + d - p] |= 128 * g
    }
}, function(e, t) {
    var n = {}.toString;
    ...
    function c(e, t, n, s) {
        var o = r.isBuffer(this),
            c = r.isBuffer(e);
        if (o && c) return this.copy(e, t, n, s);
        if (a || o || c || !r.isView(this) || !r.isView(e)) return i.copy.call(this, e, t, n, s);
        ...
        ! function(t) {
            ...
            function h(e, c, h) {
                ...
                return P.buffer = void 0, P.offset = 0, P[C] = !0, P.toNumber = R, P.toString = function(e) {
                    var t = this.buffer,
                        ...
                        s = "",
                        o = !h && 2147483648 & i;
                    for (o && (i = ~i, r = l - r), e = e || 10;;) {
                        var a = i % e * l + r;
                        if (i = Math.floor(i / e), r = Math.floor(a / e), s = (a % e).toString(e) + s, !i && !r) break
                    }
                    return o && (s = "-" + s), s
                ...
                function O(e, t, r, c) {
                    return this instanceof O ? function(e, t, r, c, h) {
                        if (s && o && (t instanceof o && (t = new s(t)), c instanceof o && (c = new s(c))), t || r || c || n) {
                            ...
                            e.buffer = t, e.offset = r |= 0, i !== typeof c && ("string" == typeof c ? function(e, t, n, i) {
                                ...
                                for (var c = r; r < s;) {
                                    ...
                                    if (!(h >= 0)) break;
                                    a = a * i + h, o = o * i + Math.floor(a / l), a %= l
                                }
                                c && (o = ~o, a ? a = l - a : o++), j(e, t + b, o), j(e, t + x, a)
                            }(t, r, c, h || 10) : p(c, h) ? g(t, r, c, h) : "number" == typeof h ? (j(t, r + b, c), j(t, r + x, h)) : c > 0 ? M(t, r, c) : c < 0 ? A(t, r, c) : g(t, r, a, 0))
                        } else e.buffer = m(a, 0)
            ...
            function d(e) {
                var t = this.buffer,
                    i = this.offset,
                    r = t.buffer;
                if (n = s, !1 !== e && 0 === i && r instanceof o && 8 === r.byteLength) return r;
                var a = new s(8);
    ...
    (function(e) {
        ...
        function u(e, t) {
            if (h(t), e = a(e, t < 0 ? 0 : 0 | d(t)), !c.TYPED_ARRAY_SUPPORT)
        ...
        function S(e, t, n, i) {
            return V(function(e, t) {
                for (var n, i, r, s = [], o = 0; o < e.length && !((t -= 2) < 0); ++o) i = (n = e.charCodeAt(o)) >> 8, r = n % 256, s.push(r), s.push(i);
                return s
            }(t, e.length - n), e, n, i)
        }
            ...
            for (var i = [], r = t; r < n;) {
                ...
                if (r + u <= n) switch (u) {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        s = e[r + 1], o = e[r + 2], 128 == (192 & s) && 128 == (192 & o) && (c = (15 & l) << 12 | (63 & s) << 6 | 63 & o) > 2047 && (c < 55296 || c > 57343) && (h = c);
                        break;
                    case 4:
                        s = e[r + 1], o = e[r + 2], a = e[r + 3], 128 == (192 & s) && 128 == (192 & o) && 128 == (192 & a) && (c = (15 & l) << 18 | (63 & s) << 12 | (63 & o) << 6 | 63 & a) > 65535 && c < 1114112 && (h = c)
                }
        ...
        t.Buffer = c, t.SlowBuffer = function(e) {
            ...
            return function(e, t, n, i) {
                return h(t), t <= 0 ? a(e, t) : void 0 !== n ? "string" == typeof i ? a(e, t).fill(n, i) : a(e, t).fill(n) : a(e, t)
            }(null, e, t, n)
            ...
            if (t >= n) return 1;
            if (this === e) return 0;
            for (var s = (r >>>= 0) - (i >>>= 0), o = (n >>>= 0) - (t >>>= 0), a = Math.min(s, o), l = this.slice(i, r), h = e.slice(t, n), u = 0; u < a; ++u)
                if (l[u] !== h[u]) {
                    s = l[u], o = h[u];
                    break
                }
        ...
        c.prototype.slice = function(e, t) {
            ...
            if (t >>>= 0, n = void 0 === n ? this.length : n >>> 0, e || (e = 0), "number" == typeof e)
                ...
                var o = c.isBuffer(e) ? e : F(new c(e, i).toString()),
                    a = o.length;
    ...
    ! function(t) {
        ...
        var n = "listeners",
            i = {
                ...
                once: function(e, t) {
                    var n = this;
                    return i.originalListener = t, o(n, e).push(i), n;
    ...
    var r = n(23),
        ...
        g = n(58).obj,
        m = new o.TextManager,
        y = new(n(59))("moomoo.io", 3e3, a.maxPlayers, 5, !1);
    y.debugLog = !1;
    var k, v = new g(a, s),
        w = Math.PI,
        b = 2 * w;
    ...
    }, "undefined" != typeof Storage && (k = !0), S("consent") || (consentBlock.style.display = "block"), window.checkTerms = function(e) {
        e ? (consentBlock.style.display = "none", x("consent", 1)) : $("#consentShake").effect("shake")
    };
    var T, I, E, M, A, P, B, C, O, R, j, _, D, U, L = S("moofoll"),
        z = 1,
        F = Date.now(),
        H = [],
        V = [],
        ...
        Y = [],
        W = [],
        X = new p(d, W, V, H, Ze, l, a, s),
        N = n(70),
        G = n(71),
        J = new N(H, G, V, l, null, a, s),
        Q = 1,
        K = 0,
        Z = 0,
        ee = 0,
        ...
        ce = document.getElementById("enterGame"),
        le = document.getElementById("promoImg"),
        ...
        ge = document.getElementById("storeButton"),
        me = document.getElementById("chatButton"),
        ye = document.getElementById("gameCanvas"),
        ke = ye.getContext("2d"),
        ve = document.getElementById("serverBrowser"),
        we = document.getElementById("nativeResolution"),
        be = document.getElementById("showPing"),
        xe = (document.getElementById("playMusic"), document.getElementById("pingDisplay")),
        ...
        je = document.getElementById("leaderboardData"),
        _e = document.getElementById("nameInput"),
        De = document.getElementById("itemInfoHolder"),
        Ue = document.getElementById("ageText"),
        Le = document.getElementById("ageBarBody"),
        ze = document.getElementById("upgradeHolder"),
        Fe = document.getElementById("upgradeCounter"),
        He = document.getElementById("allianceMenu"),
        Ve = document.getElementById("allianceHolder"),
        qe = document.getElementById("allianceManager"),
        Ye = document.getElementById("mapDisplay"),
        We = document.getElementById("diedText"),
        Xe = document.getElementById("skinColorHolder"),
        Ne = Ye.getContext("2d");
    Ye.width = 300, Ye.height = 300;
    ...
    var it = document.getElementById("featuredYoutube"),
        rt = [{
            name: "Corrupt X",
        ...
        st = rt[s.randInt(0, rt.length - 1)];
    it.innerHTML = "<a target='_blank' class='ytLink' href='" + st.link + "'><i class='material-icons' style='vertical-align: top;'>&#xE064;</i> " + st.name + "</a>";
    var ot = !0;
    ...
    function ct(e) {
        ae.style.display = "block", Me.style.display = "none", Te.style.display = "none", We.style.display = "none", Ee.style.display = "block", Ee.innerHTML = e + "<a href='javascript:window.location.href=window.location.href' class='ytLink'>reload</a>"
    }
    window.onblur = function() {
        ...
        ! function(e) {
            y.start((function(t, n, s) {
                var o = (i ? "wss" : "ws") + "://" + t + ":8008/?gameIndex=" + s;
                r.connect(o, (function(t) {
                    xi(), setInterval(() => xi(), 2500), t ? e("disconnected") : e()
                }), {
                    id: nt,
                    d: at,
                    1: kn,
                    ...
                    p: Dt,
                    pp: bi
                }), lt(), setTimeout(() => ht(), 3e3)
            }), (function(t) {
                console.error("Vultr error:", t), alert("Error:\n" + t), e(t)
            }))
        }((function(e) {
            e ? at("disconnected") : (ce.onclick = s.checkTrusted((function() {
                window.admob ? mn() : pt()
            })), s.hookTouchEvents(ce), le.onclick = s.checkTrusted((function() {
                Ti("https://krunker.io")
            })), s.hookTouchEvents(le), ue.onclick = s.checkTrusted((function() {
                setTimeout((function() {
                    ! function() {
                        var e = ve.value,
                ...
                ln(), "block" != He.style.display ? At() : He.style.display = "none"
            })), s.hookTouchEvents(pe), ge.onclick = s.checkTrusted((function() {
                "block" != Ge.style.display ? (Ge.style.display = "block", He.style.display = "none", $t(), Ft()) : Ge.style.display = "none"
            })), s.hookTouchEvents(ge), me.onclick = s.checkTrusted((function() {
                Jt()
            })), s.hookTouchEvents(me), Ye.onclick = s.checkTrusted((function() {
                pn()
            })), s.hookTouchEvents(Ye), function() {
                for (var e = 0; e < En.length; ++e) {
                    var t = new Image;
                    t.onload = function() {
                        this.isLoaded = !0
                    }, t.src = ".././img/icons/" + En[e] + ".png", In[En[e]] = t
                }
            }(), Ee.style.display = "none", Te.style.display = "block", _e.value = S("moo_name") || "", function() {
                var e = S("native_resolution");
                Wt(e ? "true" == e : "undefined" != typeof cordova), I = "true" == S("show_ping"), xe.hidden = !I, S("moo_moosic"), setInterval((function() {
                ...
                for (t = 0; t < l.list.length + l.weapons.length; ++t) ! function(e) {
                    ...
                    if (n.translate(t.width / 2, t.height / 2), n.imageSmoothingEnabled = !1, n.webkitImageSmoothingEnabled = !1, n.mozImageSmoothingEnabled = !1, l.weapons[e]) {
                        ...
                        var i = new Image;
                        Wn[l.weapons[e].src] = i, i.onload = function() {
                            this.isLoaded = !0;
                        ...
                        i = Qn(l.list[e - l.weapons.length], !0);
                        var r, o = Math.min(t.width - a.iconPadding, i.width);
                        n.globalAlpha = 1, n.drawImage(i, -o / 2, -o / 2, o, o), n.fillStyle = "rgba(0, 0, 70, 0.1)", n.globalCompositeOperation = "source-atop", n.fillRect(-o / 2, -o / 2, o, o), document.getElementById("actionBarItem" + e).style.backgroundImage = "url(" + t.toDataURL() + ")", (r = document.getElementById("actionBarItem" + e)).onmouseover = s.checkTrusted((function() {
                            mt(l.list[e - l.weapons.length])
                        })), r.onclick = s.checkTrusted((function() {
                            gn(e - l.weapons.length)
                        })), s.hookTouchEvents(r)
                    }
                }(t);
                _e.ontouchstart = s.checkTrusted((function(e) {
                    e.preventDefault();
                    var t = prompt("enter name", e.currentTarget.value);
                    e.currentTarget.value = t.slice(0, 15)
                })), we.checked = T, we.onchange = s.checkTrusted((function(e) {
                    Wt(e.target.checked)
                })), be.checked = I, be.onchange = s.checkTrusted((function(e) {
                    I = be.checked, xe.hidden = !I, x("show_ping", I ? "true" : "false")
                }))
            }())
        }))
        ...
        for (var r in y.servers) {
            ...
            for (var u = 0; u < s.length; u++)
                for (var f = s[u], d = 0; d < f.games.length; d++) {
                    ...
                    m && (he.getElementsByTagName("span")[0].innerText = e), n += "<option value='" + e + "' " + (m ? "selected" : "") + ">" + k + "</option>"
                }
            n += "<option disabled></option>"
        }
        n += "<option disabled>All Servers - " + i + " players</option>", ve.innerHTML = n, "sandbox.moomoo.io" == location.hostname ? (e = "Back to MooMoo", t = "//moomoo.io/") : (e = "Try the sandbox", t = "//sandbox.moomoo.io/"), document.getElementById("altServer").innerHTML = "<a href='" + t + "'>" + e + "<i class='material-icons' style='font-size:10px;vertical-align:middle'>arrow_forward_ios</i></a>"
    }

    function ht() {
        var e = new XMLHttpRequest;
        e.onreadystatechange = function() {
            4 == this.readyState && (200 == this.status ? (window.vultr = JSON.parse(this.responseText), y.processServers(vultr.servers), lt()) : console.error("Failed to load server data with status code:", this.status))
        }, e.open("GET", "/serverData", !0), e.send()
    }
    ve.addEventListener("change", s.checkTrusted((function() {
        let e = ve.value.split(":");
        ...
        if (window.admob) mn();
            ...
            if (e && t) {
                ...
                i.style.display = "block", i.appendChild(n), setTimeout((function() {
                    "none" != document.getElementById("my-content").style.display ? (console.log("Ad blocked"), gt()) : console.log("Ad not blocked")
    ...
    function gt() {
        dt && (dt = !1, document.getElementById("pre-content-container").style.display = "none", document.getElementById("my-content").style.display = "none", ut = Date.now(), mn())
    }

    function mt(e, t, n) {
        if (B && e)
            if (s.removeAllChildren(De), De.classList.add("visible"), s.generateElement({
                    id: "itemInfoName",
        ...
        } else De.classList.remove("visible")
    }
    ...
    function St() {
        if (wt[0]) {
            var e = wt[0];
            s.removeAllChildren(Qe), Qe.style.display = "block", s.generateElement({
    ...
    function Tt(e) {
        q.push(e), "block" == He.style.display && At()
    }

    function It(e, t) {
        B && (B.team = e, B.isOwner = t, "block" == He.style.display && At())
    }

    function Et(e) {
        bt = e, "block" == He.style.display && At()
    }

    function Mt(e) {
        for (var t = q.length - 1; t >= 0; t--) q[t].sid == e && q.splice(t, 1);
        "block" == He.style.display && At()
    }

    function At() {
        if (B && B.alive) {
            if ($t(), Ge.style.display = "none", He.style.display = "block", s.removeAllChildren(Ve), B.team)
                for (var e = 0; e < bt.length; e += 2) ! function(e) {
                    var t = s.generateElement({
                        class: "allianceItem",
                        style: "color:" + (bt[e] == B.sid ? "#fff" : "rgba(255,255,255,0.6)"),
                        text: bt[e + 1],
                        parent: Ve
                    });
                    B.isOwner && bt[e] != B.sid && s.generateElement({
                        class: "joinAlBtn",
                        text: "Kick",
                        onclick: function() {
                            Bt(bt[e])
                ...
                for (e = 0; e < q.length; ++e) ! function(e) {
                    var t = s.generateElement({
                        class: "allianceItem",
                        style: "color:" + (q[e].sid == B.team ? "#fff" : "rgba(255,255,255,0.6)"),
                        text: q[e].sid,
                        parent: Ve
                    });
                    s.generateElement({
            ...
            s.removeAllChildren(qe), B.team ? s.generateElement({
    ...
    function Pt(e) {
        r.send("11", wt[0].sid, e), wt.splice(0, 1), St()
    }
    ...
    function Dt(e, t) {
        ...
        jt || (jt = new function() {
            this.init = function(e, t) {
                ...
                this.active && (this.scale += .05 * t, this.scale >= a.mapPingScale ? this.active = !1 : (e.globalAlpha = 1 - Math.max(0, this.scale / a.mapPingScale), e.beginPath(), e.arc(this.x / a.mapScale * Ye.width, this.y / a.mapScale * Ye.width, this.scale, 0, 2 * Math.PI), e.stroke()))
            }
        }, _t.push(jt)), jt.init(e, t)
    }
    ...
    function zt(e, t, n) {
        n ? e ? B.tailIndex = t : B.tails[t] = 1 : e ? B.skinIndex = t : B.skins[t] = 1, "block" == Ge.style.display && Ft()
    }

    function Ft() {
        if (B) {
            s.removeAllChildren(Je);
            for (var e = Lt, t = e ? Ke : $e, n = 0; n < t.length; ++n) t[n].dontSell || function(n) {
                ...
                s.hookTouchEvents(i, !0), s.generateElement({
                    ...
                    text: t[n].name,
                    parent: i
                }), (e ? B.tails[t[n].id] : B.skins[t[n].id]) ? (e ? B.tailIndex : B.skinIndex) == t[n].id ? s.generateElement({
                    class: "joinAlBtn",
    ...
    function qt() {
        Ge.style.display = "none", He.style.display = "none", $t()
    }
    ...
    function Yt(e, t) {
        ...
        for (var n = 0; n < l.list.length; ++n) {
            ...
            document.getElementById("actionBarItem" + i).style.display = B.items.indexOf(l.list[n].id) >= 0 ? "inline-block" : "none"
        }
        for (n = 0; n < l.weapons.length; ++n) document.getElementById("actionBarItem" + n).style.display = B.weapons[l.weapons[n].type] == l.weapons[n].id ? "inline-block" : "none"
    }

    function Wt(e) {
        T = e, z = e && window.devicePixelRatio || 1, we.checked = e, x("native_resolution", e.toString()), nn()
    }
    ...
    var Nt = document.getElementById("chatBox"),
        Gt = document.getElementById("chatHolder");

    function Jt() {
        Kt ? setTimeout((function() {
            var e = prompt("chat message");
            e && Qt(e)
        }), 1) : "block" == Gt.style.display ? (Nt.value && Qt(Nt.value), $t()) : (Ge.style.display = "none", He.style.display = "none", Gt.style.display = "block", Nt.focus(), ln()), Nt.value = ""
    }
    ...
    function $t() {
        Nt.value = "", Gt.style.display = "none"
    }
    var Kt, Zt, en = ["cunt", "whore", "fuck", "shit", "faggot", "nigger", "nigga", "dick", "vagina", "minge", "cock", "rape", "cum", "sex", "tits", "penis", "clit", "pussy", "meatcurtain", "jizz", "prune", "douche", "wanker", "damn", "bitch", "dick", "fag", "bastard"];
    ...
    function tn(e, t) {
        ...
        n && (n.chatMessage = function(e) {
            for (var t, n = 0; n < en.length; ++n)
                if (e.indexOf(en[n]) > -1) {
                    t = "";
                    for (var i = 0; i < en[n].length; ++i) t += t.length ? "o" : "M";
                    var r = new RegExp(en[n], "g");
                    e = e.replace(r, t)
                }
            return e
    ...
    function nn() {
        D = window.innerWidth, U = window.innerHeight;
        var e = Math.max(D / re, U / se) * z;
        ye.width = D * z, ye.height = U * z, ye.style.width = D + "px", ye.style.height = U + "px", ke.setTransform(e, 0, 0, e, (D * z - re * e) / 2, (U * z - se * e) / 2)
    }

    function rn(e) {
        (Kt = e) ? Ie.classList.add("touch"): Ie.classList.remove("touch")
    }

    function sn(e) {
        e.preventDefault(), e.stopPropagation(), rn(!0);
        for (var t = 0; t < e.changedTouches.length; t++) {
            var n = e.changedTouches[t];
            n.identifier == te.id ? (te.id = -1, dn()) : n.identifier == ne.id && (ne.id = -1, B.buildIndex >= 0 && (P = 1, un()), P = 0, un())
        }
    }

    function on() {
        return B ? (-1 != ne.id ? Zt = Math.atan2(ne.currentY - ne.startY, ne.currentX - ne.startX) : B.lockDir || Kt || (Zt = Math.atan2(ee - U / 2, Z - D / 2)), s.fixTo(Zt || 0, 2)) : 0
    }
    window.addEventListener("resize", s.checkTrusted(nn)), nn(), rn(!1), window.setUsingTouch = rn, ye.addEventListener("touchmove", s.checkTrusted((function(e) {
        e.preventDefault(), e.stopPropagation(), rn(!0);
        for (var t = 0; t < e.changedTouches.length; t++) {
            var n = e.changedTouches[t];
            n.identifier == te.id ? (te.currentX = n.pageX, te.currentY = n.pageY, dn()) : n.identifier == ne.id && (ne.currentX = n.pageX, ne.currentY = n.pageY, P = 1)
        }
    })), !1), ye.addEventListener("touchstart", s.checkTrusted((function(e) {
        e.preventDefault(), e.stopPropagation(), rn(!0);
        for (var t = 0; t < e.changedTouches.length; t++) {
            var n = e.changedTouches[t];
            n.pageX < document.body.scrollWidth / 2 && -1 == te.id ? (te.id = n.identifier, te.startX = te.currentX = n.pageX, te.startY = te.currentY = n.pageY, dn()) : n.pageX > document.body.scrollWidth / 2 && -1 == ne.id && (ne.id = n.identifier, ne.startX = ne.currentX = n.pageX, ne.startY = ne.currentY = n.pageY, B.buildIndex < 0 && (P = 1, un()))
        }
    })), !1), ye.addEventListener("touchend", s.checkTrusted(sn), !1), ye.addEventListener("touchcancel", s.checkTrusted(sn), !1), ye.addEventListener("touchleave", s.checkTrusted(sn), !1), ye.addEventListener("mousemove", (function(e) {
        e.preventDefault(), e.stopPropagation(), rn(!1), Z = e.clientX, ee = e.clientY
    ...
    function hn() {
        return "block" != He.style.display && "block" != Gt.style.display
    }

    function un() {
        B && B.alive && r.send("c", P, B.buildIndex >= 0 ? on() : null)
    }
    window.addEventListener("keydown", s.checkTrusted((function(e) {
        var t = e.which || e.keyCode || 0;
        27 == t ? qt() : B && B.alive && hn() && (an[t] || (an[t] = 1, 69 == t ? r.send("7", 1) : 67 == t ? (vt || (vt = {}), vt.x = B.x, vt.y = B.y) : 88 == t ? (B.lockDir = B.lockDir ? 0 : 1, r.send("7", 0)) : null != B.weapons[t - 49] ? gn(B.weapons[t - 49], !0) : null != B.items[t - 49 - B.weapons.length] ? gn(B.items[t - 49 - B.weapons.length]) : 81 == t ? gn(B.items[0]) : 82 == t ? pn() : cn[t] ? dn() : 32 == t && (P = 1, un())))
    }))), window.addEventListener("keyup", s.checkTrusted((function(e) {
        if (B && B.alive) {
            var t = e.which || e.keyCode || 0;
            13 == t ? Jt() : hn() && an[t] && (an[t] = 0, cn[t] ? dn() : 32 == t && (P = 0, un()))
        }
    })));
    var fn = void 0;
    ...
    function dn() {
        var e = function() {
            ...
            if (-1 != te.id) e += te.currentX - te.startX, t += te.currentY - te.startY;
                ...
                for (var n in cn) {
                    var i = cn[n];
                    e += !!an[n] * i[0], t += !!an[n] * i[1]
                }
            return 0 == e && 0 == t ? void 0 : s.fixTo(Math.atan2(t, e), 2)
        }();
        (null == fn || null == e || Math.abs(e - fn) > .3) && (r.send("33", e), fn = e)
    }
    ...
    function mn() {
        x("moo_name", _e.value), !oe && r.connected && (oe = !0, v.stop("menu"), ct("Loading..."), r.send("sp", {
            name: _e.value,
            moofoll: L,
            skin: ie
        }))
    ...
    function kn(e) {
        Ee.style.display = "none", Te.style.display = "block", ae.style.display = "none", an = {}, C = e, P = 0, oe = !0, yn && (yn = !1, Y.length = 0)
    }
    ...
    function bn() {
        ...
        Me.style.display = "none", qt(), yt = {
            x: B.x,
            y: B.y
        }, Ee.style.display = "none", We.style.display = "block", We.style.fontSize = "0px", wn = 0, setTimeout((function() {
            Te.style.display = "block", ae.style.display = "block", We.style.display = "none"
        }), a.deathFadeout), ht()
    }
    ...
    function An(e, t) {
        if (B.upgradePoints = e, B.upgrAge = t, e > 0) {
            Mn.length = 0, s.removeAllChildren(ze);
            for (var n = 0; n < l.weapons.length; ++n) l.weapons[n].age == t && (null == l.weapons[n].pre || B.weapons.indexOf(l.weapons[n].pre) >= 0) && (s.generateElement({
                id: "upgradeItem" + n,
                class: "actionBarItem",
                onmouseout: function() {
                    mt()
                ...
                parent: ze
            }).style.backgroundImage = document.getElementById("actionBarItem" + n).style.backgroundImage, Mn.push(n));
            for (n = 0; n < l.list.length; ++n)
                if (l.list[n].age == t && (null == l.list[n].pre || B.items.indexOf(l.list[n].pre) >= 0)) {
                    var i = l.weapons.length + n;
                    s.generateElement({
                        id: "upgradeItem" + i,
                        class: "actionBarItem",
                        ...
                        parent: ze
                    }).style.backgroundImage = document.getElementById("actionBarItem" + i).style.backgroundImage, Mn.push(i)
                }
            for (n = 0; n < Mn.length; n++) ! function(e) {
                var t = document.getElementById("upgradeItem" + e);
                t.onmouseover = function() {
                    l.weapons[e] ? mt(l.weapons[e], !0) : mt(l.list[e - l.weapons.length])
                }, t.onclick = s.checkTrusted((function() {
                    r.send("6", e)
                })), s.hookTouchEvents(t)
            }(Mn[n]);
            Mn.length ? (ze.style.display = "block", Fe.style.display = "block", Fe.innerHTML = "SELECT ITEMS (" + e + ")") : (ze.style.display = "none", Fe.style.display = "none", mt())
        } else ze.style.display = "none", Fe.style.display = "none", mt()
    }

    function Pn(e, t, n) {
        null != e && (B.XP = e), null != t && (B.maxXP = t), null != n && (B.age = n), n == a.maxAge ? (Ue.innerHTML = "MAX AGE", Le.style.width = "100%") : (Ue.innerHTML = "AGE " + B.age, Le.style.width = B.XP / B.maxXP * 100 + "%")
    }
        ...
        for (var t = 1, n = 0; n < e.length; n += 3) ! function(n) {
            s.generateElement({
                ...
                children: [s.generateElement({
                    ...
                    style: "color:" + (e[n] == C ? "#fff" : "rgba(255,255,255,0.6)"),
    ...
    function Cn(e, t, n, i) {
        ke.save(), ke.setTransform(1, 0, 0, 1, 0, 0), ke.scale(z, z);
        var r = 50;
        ke.beginPath(), ke.arc(e, t, r, 0, 2 * Math.PI, !1), ke.closePath(), ke.fillStyle = "rgba(255, 255, 255, 0.3)", ke.fill(), r = 50;
        var s = n - e,
            o = i - t,
            a = Math.sqrt(Math.pow(s, 2) + Math.pow(o, 2)),
            c = a > r ? a / r : 1;
        s /= c, o /= c, ke.beginPath(), ke.arc(e + s, t + o, .5 * r, 0, 2 * Math.PI, !1), ke.closePath(), ke.fillStyle = "white", ke.fill(), ke.restore()
    }

    function On(e, t, n) {
        for (var i = 0; i < W.length; ++i)(O = W[i]).active && O.layer == e && (O.update(E), O.active && hi(O.x - t, O.y - n, O.scale) && (ke.save(), ke.translate(O.x - t, O.y - n), ke.rotate(O.dir), jn(0, 0, O, ke, 1), ke.restore()))
    }
    var Rn = {};
    ...
    function jn(e, t, n, i, r) {
        if (n.src) {
            ...
            o || ((o = new Image).onload = function() {
                this.isLoaded = !0
            }, o.src = ".././img/weapons/" + s + ".png", Rn[s] = o), o.isLoaded && i.drawImage(o, e - n.scale / 2, t - n.scale / 2, n.scale, n.scale)
        } else 1 == n.indx && (i.fillStyle = "#939393", $n(e, t, n.scale, i))
    }

    function _n(e, t, n, i) {
        var r = a.riverWidth + i,
            s = a.mapScale / 2 - t - r / 2;
        s < se && s + r > 0 && n.fillRect(0, s, re, r)
    }

    function Dn(e, t, n) {
        for (var i, r, s, o = 0; o < Y.length; ++o)(O = Y[o]).active && (r = O.x + O.xWiggle - t, s = O.y + O.yWiggle - n, 0 == e && O.update(E), O.layer == e && hi(r, s, O.scale + (O.blocker || 0)) && (ke.globalAlpha = O.hideFromEnemy ? .6 : 1, O.isItem ? (i = Qn(O), ke.save(), ke.translate(r, s), ke.rotate(O.dir), ke.drawImage(i, -i.width / 2, -i.height / 2), O.blocker && (ke.strokeStyle = "#db6e6e", ke.globalAlpha = .3, ke.lineWidth = 6, $n(0, 0, O.blocker, ke, !1, !0)), ke.restore()) : (i = Gn(O), ke.drawImage(i, r - i.width / 2, s - i.height / 2))))
    }

    function Un(e, t, n) {
        (O = yi(e)) && O.startAnim(t, n)
    }

    function Ln(e, t, n) {
        ke.globalAlpha = 1;
        for (var i = 0; i < V.length; ++i)(O = V[i]).zIndex == n && (O.animate(E), O.visible && (O.skinRot += .002 * E, _ = (O == B ? on() : O.dir) + O.dirPlus, ke.save(), ke.translate(O.x - e, O.y - t), ke.rotate(_), zn(O, ke), ke.restore()))
    }

    function zn(e, t) {
        (t = t || ke).lineWidth = 5.5, t.lineJoin = "miter";
        ...
        if (e.tailIndex > 0 && function(e, t, n) {
                if (!(Fn = qn[e])) {
                    ...
                    }, i.src = ".././img/accessories/access_" + e + ".png", qn[e] = i, Fn = i
                }
                var r = Yn[e];
                if (!r) {
                ...
                Fn.isLoaded && (t.save(), t.translate(-20 - (r.xOff || 0), 0), r.spin && t.rotate(n.skinRot), t.drawImage(Fn, -r.scale / 2, -r.scale / 2, r.scale, r.scale), t.restore())
            }(e.tailIndex, t, e), e.buildIndex < 0 && !l.weapons[e.weaponIndex].aboveHand && (Xn(l.weapons[e.weaponIndex], a.weaponVariants[e.weaponVariant].src, e.scale, 0, t), null == l.weapons[e.weaponIndex].projectile || l.weapons[e.weaponIndex].hideProjectile || jn(e.scale, 0, l.projectiles[l.weapons[e.weaponIndex].projectile], ke)), t.fillStyle = a.skinColors[e.skinColor], $n(e.scale * Math.cos(n), e.scale * Math.sin(n), 14), $n(e.scale * r * Math.cos(-n * i), e.scale * r * Math.sin(-n * i), 14), e.buildIndex < 0 && l.weapons[e.weaponIndex].aboveHand && (Xn(l.weapons[e.weaponIndex], a.weaponVariants[e.weaponVariant].src, e.scale, 0, t), null == l.weapons[e.weaponIndex].projectile || l.weapons[e.weaponIndex].hideProjectile || jn(e.scale, 0, l.projectiles[l.weapons[e.weaponIndex].projectile], ke)), e.buildIndex >= 0) {
            var s = Qn(l.list[e.buildIndex]);
            t.drawImage(s, e.scale - l.list[e.buildIndex].holdOffset, -s.width / 2)
        }
        $n(0, 0, e.scale, t), e.skinIndex > 0 && (t.rotate(Math.PI / 2), function e(t, n, i, r) {
            if (!(Fn = Hn[t])) {
                var s = new Image;
                s.onload = function() {
                    this.isLoaded = !0, this.onload = null
                }, s.src = ".././img/hats/hat_" + t + ".png", Hn[t] = s, Fn = s
            }
            var o = i || Vn[t];
            if (!o) {
            ...
            Fn.isLoaded && n.drawImage(Fn, -o.scale / 2, -o.scale / 2, o.scale, o.scale), !i && o.topSprite && (n.save(), n.rotate(r.skinRot), e(t + "_top", n, o, r), n.restore())
    ...
    function Xn(e, t, n, i, r) {
        ...
        o || ((o = new Image).onload = function() {
            this.isLoaded = !0
        }, o.src = ".././img/weapons/" + s + ".png", Wn[s] = o), o.isLoaded && r.drawImage(o, n + e.xOff - e.length / 2, i + e.yOff - e.width / 2, e.length, e.width)
    }
    var Nn = {};
    ...
    function Gn(e) {
        ...
        if (!i) {
            ...
            if (o.translate(r.width / 2, r.height / 2), o.rotate(s.randFloat(0, Math.PI)), o.strokeStyle = et, o.lineWidth = 5.5, 0 == e.type)
                for (var c, l = 0; l < 2; ++l) Kn(o, 7, c = O.scale * (l ? .5 : 1), .7 * c), o.fillStyle = t ? l ? "#fff" : "#e3f1f4" : l ? "#b4db62" : "#9ebf57", o.fill(), l || o.stroke();
            else if (1 == e.type)
                if (2 == t) o.fillStyle = "#606060", Kn(o, 6, .3 * e.scale, .71 * e.scale), o.fill(), o.stroke(), o.fillStyle = "#89a54c", $n(0, 0, .55 * e.scale, o), o.fillStyle = "#a5c65b", $n(0, 0, .3 * e.scale, o, !0);
                else {
                    var h;
                    ! function(e, t, n, i) {
                        var r, o = Math.PI / 2 * 3,
                        ...
                        for (var c = 0; c < 6; c++) r = s.randInt(n + .9, 1.2 * n), e.quadraticCurveTo(Math.cos(o + a) * r, Math.sin(o + a) * r, Math.cos(o + 2 * a) * i, Math.sin(o + 2 * a) * i), o += 2 * a;
                        e.lineTo(0, -i), e.closePath()
                    }(o, 0, O.scale, .7 * O.scale), o.fillStyle = t ? "#e3f1f4" : "#89a54c", o.fill(), o.stroke(), o.fillStyle = t ? "#6a64af" : "#c15555";
                    var u = b / 4;
                    for (l = 0; l < 4; ++l) $n((h = s.randInt(O.scale / 3.5, O.scale / 2.3)) * Math.cos(u * l), h * Math.sin(u * l), s.randInt(10, 12), o)
                }
            else 2 != e.type && 3 != e.type || (o.fillStyle = 2 == e.type ? 2 == t ? "#938d77" : "#939393" : "#e0c655", Kn(o, 3, e.scale, e.scale), o.fill(), o.stroke(), o.fillStyle = 2 == e.type ? 2 == t ? "#b2ab90" : "#bcbcbc" : "#ebdca3", Kn(o, 3, .55 * e.scale, .65 * e.scale), o.fill());
            i = r, Nn[n] = i
        }
        return i
    }
    ...
    function Qn(e, t) {
        ...
        if (!n || t) {
            ...
            if (r.translate(i.width / 2, i.height / 2), r.rotate(t ? 0 : Math.PI / 2), r.strokeStyle = et, r.lineWidth = 5.5 * (t ? i.width / 81 : 1), "apple" == e.name) {
                r.fillStyle = "#c15555", $n(0, 0, e.scale, r), r.fillStyle = "#89a54c";
                var o = -Math.PI / 2;
                ! function(e, t, n, i, r) {
                    var s = e + 25 * Math.cos(i),
                        o = t + 25 * Math.sin(i);
                    r.moveTo(e, t), r.beginPath(), r.quadraticCurveTo((e + s) / 2 + 10 * Math.cos(i + Math.PI / 2), (t + o) / 2 + 10 * Math.sin(i + Math.PI / 2), s, o), r.quadraticCurveTo((e + s) / 2 - 10 * Math.cos(i + Math.PI / 2), (t + o) / 2 - 10 * Math.sin(i + Math.PI / 2), e, t), r.closePath(), r.fill(), r.stroke()
                }(e.scale * Math.cos(o), e.scale * Math.sin(o), 0, o + Math.PI / 2, r)
            } else if ("cookie" == e.name) {
                r.fillStyle = "#cca861", $n(0, 0, e.scale, r), r.fillStyle = "#937c4b";
                for (var a = b / (h = 4), c = 0; c < h; ++c) $n((u = s.randInt(e.scale / 2.5, e.scale / 1.7)) * Math.cos(a * c), u * Math.sin(a * c), s.randInt(4, 5), r, !0)
            } else if ("cheese" == e.name) {
                var h, u;
                for (r.fillStyle = "#f4f3ac", $n(0, 0, e.scale, r), r.fillStyle = "#c3c28b", a = b / (h = 4), c = 0; c < h; ++c) $n((u = s.randInt(e.scale / 2.5, e.scale / 1.7)) * Math.cos(a * c), u * Math.sin(a * c), s.randInt(4, 5), r, !0)
                ...
                Kn(r, f, 1.1 * e.scale, 1.1 * e.scale), r.fill(), r.stroke(), r.fillStyle = "castle wall" == e.name ? "#9da4aa" : "wood wall" == e.name ? "#c9b758" : "#bcbcbc", Kn(r, f, .65 * e.scale, .65 * e.scale), r.fill()
                ...
                var d = .6 * e.scale;
                Kn(r, "spikes" == e.name ? 5 : 6, e.scale, d), r.fill(), r.stroke(), r.fillStyle = "#a5974c", $n(0, 0, d, r), r.fillStyle = "#c9b758", $n(0, 0, d / 2, r, !0)
            } else if ("windmill" == e.name || "faster windmill" == e.name || "power mill" == e.name) r.fillStyle = "#a5974c", $n(0, 0, e.scale, r), r.fillStyle = "#c9b758", ei(0, 0, 1.5 * e.scale, 29, 4, r), r.fillStyle = "#a5974c", $n(0, 0, .5 * e.scale, r);
            else if ("mine" == e.name) r.fillStyle = "#939393", Kn(r, 3, e.scale, e.scale), r.fill(), r.stroke(), r.fillStyle = "#bcbcbc", Kn(r, 3, .55 * e.scale, .65 * e.scale), r.fill();
            else if ("sapling" == e.name)
                for (c = 0; c < 2; ++c) Kn(r, 7, d = e.scale * (c ? .5 : 1), .7 * d), r.fillStyle = c ? "#b4db62" : "#9ebf57", r.fill(), c || r.stroke();
            else if ("pit trap" == e.name) r.fillStyle = "#a5974c", Kn(r, 3, 1.1 * e.scale, 1.1 * e.scale), r.fill(), r.stroke(), r.fillStyle = et, Kn(r, 3, .65 * e.scale, .65 * e.scale), r.fill();
            else if ("boost pad" == e.name) r.fillStyle = "#7e7f82", Zn(0, 0, 2 * e.scale, 2 * e.scale, r), r.fill(), r.stroke(), r.fillStyle = "#dbd97d",
                function(e, t) {
                    t = t || ke;
                    var n = e * (Math.sqrt(3) / 2);
                    t.beginPath(), t.moveTo(0, -n / 2), t.lineTo(-e / 2, n / 2), t.lineTo(e / 2, n / 2), t.lineTo(0, -n / 2), t.fill(), t.closePath()
                }(1 * e.scale, r);
            else if ("turret" == e.name) r.fillStyle = "#a5974c", $n(0, 0, e.scale, r), r.fill(), r.stroke(), r.fillStyle = "#939393", Zn(0, -25, .9 * e.scale, 50, r), $n(0, 0, .6 * e.scale, r), r.fill(), r.stroke();
            else if ("platform" == e.name) {
                r.fillStyle = "#cebd5f";
                var p = 2 * e.scale,
                    g = p / 4,
                    m = -e.scale / 2;
                for (c = 0; c < 4; ++c) Zn(m - g / 2, 0, g, 2 * e.scale, r), r.fill(), r.stroke(), m += p / 4
            } else "healing pad" == e.name ? (r.fillStyle = "#7e7f82", Zn(0, 0, 2 * e.scale, 2 * e.scale, r), r.fill(), r.stroke(), r.fillStyle = "#db6e6e", ei(0, 0, .65 * e.scale, 20, 4, r, !0)) : "spawn pad" == e.name ? (r.fillStyle = "#7e7f82", Zn(0, 0, 2 * e.scale, 2 * e.scale, r), r.fill(), r.stroke(), r.fillStyle = "#71aad6", $n(0, 0, .6 * e.scale, r)) : "blocker" == e.name ? (r.fillStyle = "#7e7f82", $n(0, 0, e.scale, r), r.fill(), r.stroke(), r.rotate(Math.PI / 4), r.fillStyle = "#db6e6e", ei(0, 0, .65 * e.scale, 20, 4, r, !0)) : "teleporter" == e.name && (r.fillStyle = "#7e7f82", $n(0, 0, e.scale, r), r.fill(), r.stroke(), r.rotate(Math.PI / 4), r.fillStyle = "#d76edb", $n(0, 0, .5 * e.scale, r, !0));
            n = i, t || (Jn[e.id] = n)
        }
        return n
    }
    ...
    function $n(e, t, n, i, r, s) {
        (i = i || ke).beginPath(), i.arc(e, t, n, 0, 2 * Math.PI), s || i.fill(), r || i.stroke()
    }

    function Kn(e, t, n, i) {
        var r, s, o = Math.PI / 2 * 3,
            a = Math.PI / t;
        e.beginPath(), e.moveTo(0, -n);
        for (var c = 0; c < t; c++) r = Math.cos(o) * n, s = Math.sin(o) * n, e.lineTo(r, s), o += a, r = Math.cos(o) * i, s = Math.sin(o) * i, e.lineTo(r, s), o += a;
    ...
    function ei(e, t, n, i, r, s, o) {
        ...
        for (var a = 0; a < r; a++) Zn(0, 0, 2 * n, i, s, o), s.rotate(Math.PI / r);
        s.restore()
    }

    function ti(e) {
        for (var t = 0; t < e.length;) Ze.add(e[t], e[t + 1], e[t + 2], e[t + 3], e[t + 4], e[t + 5], l.list[e[t + 6]], !0, e[t + 7] >= 0 ? {
            sid: e[t + 7]
        } : null), t += 8
    }

    function ni(e, t) {
        (O = vi(t)) && (O.xWiggle += a.gatherWiggle * Math.cos(e), O.yWiggle += a.gatherWiggle * Math.sin(e))
    }

    function ii(e, t) {
        (O = vi(e)) && (O.dir = t, O.xWiggle += a.gatherWiggle * Math.cos(t + Math.PI), O.yWiggle += a.gatherWiggle * Math.sin(t + Math.PI))
    }

    function ri(e, t, n, i, r, s, o, a) {
        ot && (X.addProjectile(e, t, n, i, r, s, null, null, o).sid = a)
    }

    function si(e, t) {
        for (var n = 0; n < W.length; ++n) W[n].sid == e && (W[n].range = t)
    }
    ...
    function ai(e) {
        for (var t = 0; t < H.length; ++t) H[t].forcePos = !H[t].visible, H[t].visible = !1;
        if (e) {
            var n = Date.now();
            for (t = 0; t < e.length;)(O = ki(e[t])) ? (O.index = e[t + 1], O.t1 = void 0 === O.t2 ? n : O.t2, O.t2 = n, O.x1 = O.x, O.y1 = O.y, O.x2 = e[t + 2], O.y2 = e[t + 3], O.d1 = void 0 === O.d2 ? e[t + 4] : O.d2, O.d2 = e[t + 4], O.health = e[t + 5], O.dt = 0, O.visible = !0) : ((O = J.spawn(e[t + 2], e[t + 3], e[t + 4], e[t + 1])).x2 = O.x, O.y2 = O.y, O.d2 = O.dir, O.health = e[t + 5], J.aiTypes[e[t + 1]].name || (O.name = a.cowNames[e[t + 6]]), O.forcePos = !0, O.sid = e[t], O.visible = !0), t += 7
        }
    }
    var ci = {};
    ...
    function li(e, t) {
        ...
        if (!i) {
            ...
            r.onload = function() {
                this.isLoaded = !0, this.onload = null
            }, r.src = ".././img/animals/" + e.src + ".png", i = r, ci[n] = i
        }
        if (i.isLoaded) {
    ...
    function hi(e, t, n) {
        return e + n >= 0 && e - n <= re && t + n >= 0 && t - n <= se
    }
    ...
    function ui(e, t) {
        ...
        n || (n = new u(e[0], e[1], a, s, X, Ze, V, H, l, $e, Ke), V.push(n)), n.spawn(t ? L : null), n.visible = !1, n.x2 = void 0, n.y2 = void 0, n.setData(e), t && (R = (B = n).x, j = B.y, Yt(), Tn(), Pn(), An(0), Me.style.display = "block")
    }
    ...
    function bi() {
        var e = Date.now() - wi;
        window.pingTime = e, xe.innerText = "Ping: " + e + " ms"
    }

    function xi() {
        wi = Date.now(), r.send("pp")
    }
    ...
    window.requestAnimFrame = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || function(e) {
        ...
        function() {
            var e = a.mapScale / 2;
            Ze.add(0, e, e + 200, 0, a.treeScales[3], 0), Ze.add(1, e, e - 480, 0, a.treeScales[3], 0), Ze.add(2, e + 300, e + 450, 0, a.treeScales[3], 0), Ze.add(3, e - 950, e - 130, 0, a.treeScales[2], 0), Ze.add(4, e - 750, e - 400, 0, a.treeScales[3], 0), Ze.add(5, e - 700, e + 400, 0, a.treeScales[2], 0), Ze.add(6, e + 800, e - 200, 0, a.treeScales[3], 0), Ze.add(7, e - 260, e + 340, 0, a.bushScales[3], 1), Ze.add(8, e + 760, e + 310, 0, a.bushScales[3], 1), Ze.add(9, e - 800, e + 100, 0, a.bushScales[3], 1), Ze.add(10, e - 800, e + 300, 0, l.list[4].scale, l.list[4].id, l.list[10]), Ze.add(11, e + 650, e - 390, 0, l.list[4].scale, l.list[4].id, l.list[10]), Ze.add(12, e - 400, e - 450, 0, a.rockScales[2], 2)
        }(),
        function e() {
            M = Date.now(), E = M - F, F = M,
                function() {
                    if (B && (!A || M - A >= 1e3 / a.clientSendRate) && (A = M, r.send("2", on())), wn < 120 && (wn += .1 * E, We.style.fontSize = Math.min(Math.round(wn), 120) + "px"), B) {
                        var e = s.getDistance(R, j, B.x, B.y),
                            t = s.getDirection(B.x, B.y, R, j),
                            n = Math.min(.01 * e * E, e);
                        e > .05 ? (R += n * Math.cos(t), j += n * Math.sin(t)) : (R = B.x, j = B.y)
                    } else R = a.mapScale / 2, j = a.mapScale / 2;
                    for (var i = M - 1e3 / a.serverUpdateRate, o = 0; o < V.length + H.length; ++o)
                        if ((O = V[o] || H[o - V.length]) && O.visible)
                            if (O.forcePos) O.x = O.x2, O.y = O.y2, O.dir = O.d2;
                            else {
                                var c = O.t2 - O.t1,
                                    l = (i - O.t1) / c;
                                O.dt += E;
                                var h = Math.min(1.7, O.dt / 170),
                                    u = O.x2 - O.x1;
                                O.x = O.x1 + u * h, u = O.y2 - O.y1, O.y = O.y1 + u * h, O.dir = Math.lerpAngle(O.d2, O.d1, Math.min(1.2, l))
                            }
                    var f = R - re / 2,
                        d = j - se / 2;
                    a.snowBiomeTop - d <= 0 && a.mapScale - a.snowBiomeTop - d >= se ? (ke.fillStyle = "#b6db66", ke.fillRect(0, 0, re, se)) : a.mapScale - a.snowBiomeTop - d <= 0 ? (ke.fillStyle = "#dbc666", ke.fillRect(0, 0, re, se)) : a.snowBiomeTop - d >= se ? (ke.fillStyle = "#fff", ke.fillRect(0, 0, re, se)) : a.snowBiomeTop - d >= 0 ? (ke.fillStyle = "#fff", ke.fillRect(0, 0, re, a.snowBiomeTop - d), ke.fillStyle = "#b6db66", ke.fillRect(0, a.snowBiomeTop - d, re, se - (a.snowBiomeTop - d))) : (ke.fillStyle = "#b6db66", ke.fillRect(0, 0, re, a.mapScale - a.snowBiomeTop - d), ke.fillStyle = "#dbc666", ke.fillRect(0, a.mapScale - a.snowBiomeTop - d, re, se - (a.mapScale - a.snowBiomeTop - d))), yn || ((Q += K * a.waveSpeed * E) >= a.waveMax ? (Q = a.waveMax, K = -1) : Q <= 1 && (Q = K = 1), ke.globalAlpha = 1, ke.fillStyle = "#dbc666", _n(f, d, ke, a.riverPadding), ke.fillStyle = "#91b2db", _n(f, d, ke, 250 * (Q - 1))), ke.lineWidth = 4, ke.strokeStyle = "#000", ke.globalAlpha = .06, ke.beginPath();
                    for (var p = -R; p < re; p += se / 18) p > 0 && (ke.moveTo(p, 0), ke.lineTo(p, se));
                    for (var g = -j; g < se; g += se / 18) p > 0 && (ke.moveTo(0, g), ke.lineTo(re, g));
                    for (ke.stroke(), ke.globalAlpha = 1, ke.strokeStyle = et, Dn(-1, f, d), ke.globalAlpha = 1, ke.lineWidth = 5.5, On(0, f, d), Ln(f, d, 0), ke.globalAlpha = 1, o = 0; o < H.length; ++o)(O = H[o]).active && O.visible && (O.animate(E), ke.save(), ke.translate(O.x - f, O.y - d), ke.rotate(O.dir + O.dirPlus - Math.PI / 2), li(O, ke), ke.restore());
                    if (Dn(0, f, d), On(1, f, d), Dn(1, f, d), Ln(f, d, 1), Dn(2, f, d), Dn(3, f, d), ke.fillStyle = "#000", ke.globalAlpha = .09, f <= 0 && ke.fillRect(0, 0, -f, se), a.mapScale - f <= re) {
                        var y = Math.max(0, -d);
                        ke.fillRect(a.mapScale - f, y, re - (a.mapScale - f), se - y)
                    }
                    if (d <= 0 && ke.fillRect(-f, 0, re + f, -d), a.mapScale - d <= se) {
                        var k = Math.max(0, -f),
                            v = 0;
                        a.mapScale - f <= re && (v = re - (a.mapScale - f)), ke.fillRect(k, a.mapScale - d, re - k - v, se - (a.mapScale - d))
                    }
                    for (ke.globalAlpha = 1, ke.fillStyle = "rgba(0, 0, 70, 0.35)", ke.fillRect(0, 0, re, se), ke.strokeStyle = tt, o = 0; o < V.length + H.length; ++o)
                        if ((O = V[o] || H[o - V.length]).visible && (10 != O.skinIndex || O == B || O.team && O.team == B.team)) {
                            var w = (O.team ? "[" + O.team + "] " : "") + (O.name || "");
                            if ("" != w) {
                                if (ke.font = (O.nameScale || 30) + "px Hammersmith One", ke.fillStyle = "#fff", ke.textBaseline = "middle", ke.textAlign = "center", ke.lineWidth = O.nameScale ? 11 : 8, ke.lineJoin = "round", ke.strokeText(w, O.x - f, O.y - d - O.scale - a.nameY), ke.fillText(w, O.x - f, O.y - d - O.scale - a.nameY), O.isLeader && In.crown.isLoaded) {
                                    var b = a.crownIconScale;
                                    k = O.x - f - b / 2 - ke.measureText(w).width / 2 - a.crownPad, ke.drawImage(In.crown, k, O.y - d - O.scale - a.nameY - b / 2 - 5, b, b)
                                }
                                1 == O.iconIndex && In.skull.isLoaded && (b = a.crownIconScale, k = O.x - f - b / 2 + ke.measureText(w).width / 2 + a.crownPad, ke.drawImage(In.skull, k, O.y - d - O.scale - a.nameY - b / 2 - 5, b, b))
                            }
                            O.health > 0 && (a.healthBarWidth, ke.fillStyle = tt, ke.roundRect(O.x - f - a.healthBarWidth - a.healthBarPad, O.y - d + O.scale + a.nameY, 2 * a.healthBarWidth + 2 * a.healthBarPad, 17, 8), ke.fill(), ke.fillStyle = O == B || O.team && O.team == B.team ? "#8ecc51" : "#cc5151", ke.roundRect(O.x - f - a.healthBarWidth, O.y - d + O.scale + a.nameY + a.healthBarPad, 2 * a.healthBarWidth * (O.health / O.maxHealth), 17 - 2 * a.healthBarPad, 7), ke.fill())
                        }
                    for (m.update(E, ke, f, d), o = 0; o < V.length; ++o)
                        if ((O = V[o]).visible && O.chatCountdown > 0) {
                            O.chatCountdown -= E, O.chatCountdown <= 0 && (O.chatCountdown = 0), ke.font = "32px Hammersmith One";
                            var x = ke.measureText(O.chatMessage);
                            ke.textBaseline = "middle", ke.textAlign = "center", k = O.x - f, y = O.y - O.scale - d - 90;
                            var S = x.width + 17;
                            ke.fillStyle = "rgba(0,0,0,0.2)", ke.roundRect(k - S / 2, y - 23.5, S, 47, 6), ke.fill(), ke.fillStyle = "#fff", ke.fillText(O.chatMessage, k, y)
                        }! function(e) {
                        if (B && B.alive) {
                            Ne.clearRect(0, 0, Ye.width, Ye.height), Ne.strokeStyle = "#fff", Ne.lineWidth = 4;
                            for (var t = 0; t < _t.length; ++t)(jt = _t[t]).update(Ne, e);
                            if (Ne.globalAlpha = 1, Ne.fillStyle = "#fff", $n(B.x / a.mapScale * Ye.width, B.y / a.mapScale * Ye.height, 7, Ne, !0), Ne.fillStyle = "rgba(255,255,255,0.35)", B.team && kt)
                                for (t = 0; t < kt.length;) $n(kt[t] / a.mapScale * Ye.width, kt[t + 1] / a.mapScale * Ye.height, 7, Ne, !0), t += 2;
                            yt && (Ne.fillStyle = "#fc5553", Ne.font = "34px Hammersmith One", Ne.textBaseline = "middle", Ne.textAlign = "center", Ne.fillText("x", yt.x / a.mapScale * Ye.width, yt.y / a.mapScale * Ye.height)), vt && (Ne.fillStyle = "#fff", Ne.font = "34px Hammersmith One", Ne.textBaseline = "middle", Ne.textAlign = "center", Ne.fillText("x", vt.x / a.mapScale * Ye.width, vt.y / a.mapScale * Ye.height))
                        }
                    }(E), -1 !== te.id && Cn(te.startX, te.startY, te.currentX, te.currentY), -1 !== ne.id && Cn(ne.startX, ne.startY, ne.currentX, ne.currentY)
                }(), requestAnimFrame(e)
        }(), window.openLink = Ti, window.aJoinReq = Pt, window.follmoo = function() {
            L || (L = !0, x("moofoll", 1))
        }, window.kickFromClan = Bt, window.sendJoin = Ct, window.leaveAlliance = Rt, window.createAlliance = Ot, window.storeBuy = Vt, window.storeEquip = Ht, window.showItemInfo = mt, window.selectSkinColor = function(e) {
            ie = e, Xt()
    ...
    ! function(e, t, n) {
        ...
        a.addTest("passiveeventlisteners", (function() {
            ...
            function() {
                ...
                for (var h in s)
                    if (s.hasOwnProperty(h)) {
                        ...
                        for (o = i(t.fn, "function") ? t.fn() : t.fn, c = 0; c < e.length; c++) 1 === (l = e[c].split(".")).length ? a[l[0]] = o : (!a[l[0]] || a[l[0]] instanceof Boolean || (a[l[0]] = new Boolean(a[l[0]])), a[l[0]][l[1]] = o), r.push((o ? "" : "no-") + l.join("-"))
                    }
            }(),
            function(e) {
                var t = c.className,
            ...
            }(r), delete o.addTest, delete o.addAsyncTest;
                ...
                try {
                    ...
                    this.socket = new WebSocket(o), this.socket.binaryType = "arraybuffer", this.socket.onmessage = function(e) {
                        var t = new Uint8Array(e.data),
                            s = i.decode(t),
                            o = s[0];
                        t = s[1], "io-init" == o ? r.socketId = t[0] : n[o].apply(void 0, t)
                    }, this.socket.onopen = function() {
                        r.connected = !0, t()
                    }, this.socket.onclose = function() {
                        r.connected = !1, s || t("Disconnected. Try connecting to another server.")
    ...
    t.byteLength = function(e) {
        ...
        return 2 === a && (t = r[e.charCodeAt(n)] << 2 | r[e.charCodeAt(n + 1)] >> 4, c[h++] = 255 & t), 1 === a && (t = r[e.charCodeAt(n)] << 10 | r[e.charCodeAt(n + 1)] << 4 | r[e.charCodeAt(n + 2)] >> 2, c[h++] = t >> 8 & 255, c[h++] = 255 & t), c
    }, t.fromByteArray = function(e) {
        for (var t, n = e.length, r = n % 3, s = [], o = 0, a = n - r; o < a; o += 16383) s.push(u(e, o, o + 16383 > a ? a : o + 16383));
    ...
    function m(e, t, n, i) {
        return function(r, s) {
            var o = r.reserve(t + 1);
            r.buffer[o++] = e, n.call(r.buffer, s, o, i)
        }
    }
    ...
    r.nextTick = function(e) {
        ...
        l.push(new p(e, t)), 1 !== l.length || h || a(d)
    ...
    }, e.exports.lineInRect = function(e, t, n, i, r, s, o, a) {
        var c = r,
            l = o;
        if (r > o && (c = o, l = r), l > n && (l = n), c < e && (c = e), c > l) return !1;
        var h = s,
            u = a,
            f = o - r;
        if (Math.abs(f) > 1e-7) {
    ...
    e.exports.AnimText = function() {
        this.init = function(e, t, n, i, r, s, o) {
            this.x = e, this.y = t, this.color = o, this.scale = n, this.startScale = this.scale, this.maxScale = 1.5 * n, this.scaleSpeed = .7, this.speed = i, this.life = r, this.text = s
        ...
        }, this.showText = function(t, n, i, r, s, o, a) {
            for (var c, l = 0; l < this.texts.length; ++l)
                if (!this.texts[l].life) {
                    c = this.texts[l];
                    break
                }
            c || (c = new e.exports.AnimText, this.texts.push(c)), c.init(t, n, i, r, s, o, a)
        }
    }
}, function(e, t) {
    e.exports = function(e) {
        this.sid = e, this.init = function(e, t, n, i, r, s, o) {
            s = s || {}, this.sentTo = {}, this.gridLocations = [], this.active = !0, this.doUpdate = s.doUpdate, this.x = e, this.y = t, this.dir = n, this.xWiggle = 0, this.yWiggle = 0, this.scale = i, this.type = r, this.id = s.id, this.owner = o, this.name = s.name, this.isItem = null != this.id, this.group = s.group, this.health = s.health, this.layer = 2, null != this.group ? this.layer = this.group.layer : 0 == this.type ? this.layer = 3 : 2 == this.type ? this.layer = 0 : 4 == this.type && (this.layer = -1), this.colDiv = s.colDiv || 1, this.blocker = s.blocker, this.ignoreCollision = s.ignoreCollision, this.dontGather = s.dontGather, this.hideFromEnemy = s.hideFromEnemy, this.friction = s.friction, this.projDmg = s.projDmg, this.dmg = s.dmg, this.pDmg = s.pDmg, this.pps = s.pps, this.zIndex = s.zIndex || 0, this.turnSpeed = s.turnSpeed, this.req = s.req, this.trap = s.trap, this.healCol = s.healCol, this.teleport = s.teleport, this.boostSpeed = s.boostSpeed, this.projectile = s.projectile, this.shootRange = s.shootRange, this.shootRate = s.shootRate, this.shootCount = this.shootRate, this.spawnPoint = s.spawnPoint
    ...
    e.exports = function(e, t, a, c, l, h) {
        var u, f;
        ...
        this.setObjectGrids = function(e) {
            ...
            for (var n = 0; n < l.length; ++n) l[n].active && (e.sentTo[l[n].id] && (e.active ? l[n].canSee(e) && h.send(l[n].id, "8", a.fixTo(t, 1), e.sid) : h.send(l[n].id, "12", e.sid)), e.active || e.owner != l[n] || l[n].changeItemCount(e.group.id, -1))
        };
        var p, g, m = [];
        this.getGridArrays = function(e, t, i) {
            ...
            return m
        }, this.add = function(n, i, r, s, o, a, c, l, u) {
            g = null;
            ...
            g || (g = new e(n), t.push(g)), l && (g.sid = n), g.init(i, r, s, o, a, c, u), h && (this.setObjectGrids(g), g.doUpdate && this.updateObjects.push(g))
            ...
            return n
        }, this.checkItemLocation = function(e, n, i, r, s, o, l) {
            for (var h = 0; h < t.length; ++h) {
                var u = t[h].blocker ? t[h].blocker : t[h].getScale(r, t[h].isItem);
                if (t[h].active && a.getDistance(e, n, t[h].x, t[h].y) < i + u) return !1
            }
            return !(!o && 18 != s && n >= c.mapScale / 2 - c.riverWidth / 2 && n <= c.mapScale / 2 + c.riverWidth / 2)
        }, this.addProjectile = function(e, t, n, i, r) {
            for (var s, o = items.projectiles[r], c = 0; c < projectiles.length; ++c)
                if (!projectiles[c].active) {
                    s = projectiles[c];
                    break
                }
            s || (s = new Projectile(l, a), projectiles.push(s)), s.init(r, e, t, n, o.speed, i, o.scale)
            ...
            if (i(l) <= u || i(h) <= u) {
                ...
                var f = o(l * l + h * h) - u;
                if (f <= 0) {
                    if (t.ignoreCollision) !t.trap || e.noTrap || t.owner == e || t.owner && t.owner.team && t.owner.team == e.team ? t.boostSpeed ? (e.xVel += n * t.boostSpeed * (t.weightM || 1) * r(t.dir), e.yVel += n * t.boostSpeed * (t.weightM || 1) * s(t.dir)) : t.healCol ? e.healCol = t.healCol : t.teleport && (e.x = a.randInt(0, c.mapScale), e.y = a.randInt(0, c.mapScale)) : (e.lockMove = !0, t.hideFromEnemy = !1);
                    else {
                        var d = a.getDirection(e.x, e.y, t.x, t.y);
                        if (a.getDistance(e.x, e.y, t.x, t.y), t.isPlayer ? (f = -1 * f / 2, e.x += f * r(d), e.y += f * s(d), t.x -= f * r(d), t.y -= f * s(d)) : (e.x = t.x + u * r(d), e.y = t.y + u * s(d), e.xVel *= .75, e.yVel *= .75), t.dmg && t.owner != e && (!t.owner || !t.owner.team || t.owner.team != e.team)) {
                            e.changeHealth(-t.dmg, t.owner, t);
                            var p = 1.5 * (t.weightM || 1);
                            e.xVel += p * r(d), e.yVel += p * s(d), !t.pDmg || e.skin && e.skin.poisonRes || (e.dmgOverTime.dmg = t.pDmg, e.dmgOverTime.time = 5, e.dmgOverTime.doer = t.owner), e.colDmg && t.health && (t.changeHealth(-e.colDmg) && this.disableObj(t), this.hitObj(t, a.getDirection(e.x, e.y, t.x, t.y)))
                        }
                    }
    ...
    e.exports = function(e, t, n, l, h, u, f, d, p, g, m, y, k, v) {
        ...
        this.points = 0, this.dt = 0, this.hidden = !1, this.itemCounts = {}, this.isPlayer = !0, this.pps = 0, this.moveDir = void 0, this.skinRot = 0, this.lastPing = 0, this.iconIndex = 0, this.skinColor = 0, this.spawn = function(e) {
            ...
            if (e) {
                ...
                var t = e.name + "",
                    r = !1,
                    s = (t = (t = (t = (t = t.slice(0, n.maxNameLength)).replace(/[^\w:\(\)\/? -]+/gim, " ")).replace(/[^\x00-\x7F]/g, " ")).trim()).toLowerCase().replace(/\s/g, "").replace(/1/g, "i").replace(/0/g, "o");
                for (var o of i.list)
                    if (-1 != s.indexOf(o)) {
                        r = !0;
                        break
        ...
        this.update = function(e) {
                ...
                if (this.alive) {
                    ...
                    if (this.xVel && (this.xVel *= a(n.playerDecel, e), this.xVel <= .01 && this.xVel >= -.01 && (this.xVel = 0)), this.yVel && (this.yVel *= a(n.playerDecel, e), this.yVel <= .01 && this.yVel >= -.01 && (this.yVel = 0)), this.x - this.scale < 0 ? this.x = this.scale : this.x + this.scale > n.mapScale && (this.x = n.mapScale - this.scale), this.y - this.scale < 0 ? this.y = this.scale : this.y + this.scale > n.mapScale && (this.y = n.mapScale - this.scale), this.buildIndex < 0)
                        ...
                        if (null != p.weapons[this.weaponIndex].gather) this.gather(f);
                            ...
                            p.weapons[this.weaponIndex].rec && (this.xVel -= p.weapons[this.weaponIndex].rec * s(this.dir), this.yVel -= p.weapons[this.weaponIndex].rec * o(this.dir)), h.addProjectile(this.x + E * s(this.dir), this.y + E * o(this.dir), this.dir, p.projectiles[I].range * M, p.projectiles[I].speed * M, I, this, null, this.zIndex)
                        } else T = !1;
            ...
            for (var e, t, i, r = n.fetchVariant(this), a = r.poison, c = r.val, h = {}, g = u.getGridArrays(this.x, this.y, p.weapons[this.weaponIndex].range), m = 0; m < g.length; ++m)
    ...
    e.exports = function(e, t, n, i, r, s, o) {
        this.init = function(e, t, n, i, r, s, a, c, l) {
            this.active = !0, this.indx = e, this.x = t, this.y = n, this.dir = i, this.skipMov = !0, this.speed = r, this.dmg = s, this.scale = c, this.range = a, this.owner = l, o && (this.sentTo = {})
        };
        var a, c = [];
        this.update = function(l) {
            if (this.active) {
                var h, u = this.speed * l;
                if (this.skipMov ? this.skipMov = !1 : (this.x += u * Math.cos(this.dir), this.y += u * Math.sin(this.dir), this.range -= u, this.range <= 0 && (this.x += this.range * Math.cos(this.dir), this.y += this.range * Math.sin(this.dir), u = 1, this.range = 0, this.active = !1)), o) {
                    for (var f = 0; f < e.length; ++f) !this.sentTo[e[f].id] && e[f].canSee(this) && (this.sentTo[e[f].id] = 1, o.send(e[f].id, "18", s.fixTo(this.x, 1), s.fixTo(this.y, 1), s.fixTo(this.dir, 2), s.fixTo(this.range, 1), this.speed, this.indx, this.layer, this.sid));
                    for (c.length = 0, f = 0; f < e.length + t.length; ++f) !(a = e[f] || t[f - e.length]).alive || a == this.owner || this.owner.team && a.team == this.owner.team || s.lineInRect(a.x - a.scale, a.y - a.scale, a.x + a.scale, a.y + a.scale, this.x, this.y, this.x + u * Math.cos(this.dir), this.y + u * Math.sin(this.dir)) && c.push(a);
                    for (var d = n.getGridArrays(this.x, this.y, this.scale), p = 0; p < d.length; ++p)
                        for (var g = 0; g < d[p].length; ++g) h = (a = d[p][g]).getScale(), a.active && this.ignoreObj != a.sid && this.layer <= a.layer && c.indexOf(a) < 0 && !a.ignoreCollision && s.lineInRect(a.x - h, a.y - h, a.x + h, a.y + h, this.x, this.y, this.x + u * Math.cos(this.dir), this.y + u * Math.sin(this.dir)) && c.push(a);
                    if (c.length > 0) {
                        var m = null,
                            y = null,
                            k = null;
                        ...
                        if (m.isPlayer || m.isAI) {
                            ...
                            for (m.projDmg && m.health && m.changeHealth(-this.dmg) && n.disableObj(m), f = 0; f < e.length; ++f) e[f].active && (m.sentTo[e[f].id] && (m.active ? e[f].canSee(m) && o.send(e[f].id, "8", s.fixTo(this.dir, 2), m.sid) : o.send(e[f].id, "12", m.sid)), m.active || m.owner != e[f] || e[f].changeItemCount(m.group.id, -1));
                        for (this.active = !1, f = 0; f < e.length; ++f) this.sentTo[e[f].id] && o.send(e[f].id, "19", this.sid, s.fixTo(y, 1))
                    }
                }
            }
        }
    ...
    e.exports = function(e, t, n, i, r, s, o, a, c) {
        this.addProjectile = function(l, h, u, f, d, p, g, m, y) {
            ...
            return k || ((k = new e(n, i, r, s, o, a, c)).sid = t.length, t.push(k)), k.init(p, l, h, u, d, v.dmg, f, v.scale, g), k.ignoreObj = m, k.layer = y || v.layer, k.src = v.src, k
        }
    }
}, function(e, t) {
    ...
    s.prototype.regionInfo = {
        ...
        if ("string" == typeof t) {
            ...
            if (3 == n.length) {
                var r = n[0],
                    s = parseInt(n[1]),
                    o = parseInt(n[2]);
                return "0" == r || r.startsWith("vultr:") || (r = "vultr:" + r), [r, s, o, e.query.password]
            }
        ...
        for (var n in this.servers)
            if (this.servers.hasOwnProperty(n)) {
                ...
                null != r ? function(i, r) {
                    ...
                    var o = "//" + e.serverAddress(r.ip, !0) + ":" + e.serverPort(r) + "/ping";
        ...
        if (!this.connected) {
            ...
            null != i ? (this.log("Connecting to server", i, "with game index", n), i.games[n].playerCount >= this.lobbySize ? this.errorCallback("Server is already full.") : (console.log("generating", e, t, n), window.history.replaceState(document.title, document.title, this.generateHref(e, t, n, this.password)), this.server = i, this.gameIndex = n, this.log("Calling callback with address", this.serverAddress(i.ip), "on port", this.serverPort(i), "with game index", n), this.callback(this.serverAddress(i.ip), this.serverPort(i), n))) : this.errorCallback("Failed to find server for region " + e + " and index " + t)
        }
    ...
    s.prototype.parse = function(e, t, n) {
        ...
        if (!m[b] && (S || b && !y[b])) {
            ...
            var z = this.port ? ":" + this.port : "",
                F = this.hostname || "";
            this.host = F + z, this.href += this.host, P && (this.hostname = this.hostname.substr(1, this.hostname.length - 2), "/" !== v[0] && (v = "/" + v))
        }
        if (!g[x])
        ...
        var t = this.protocol || "",
            ...
            s = !1,
            o = "";
        this.host ? s = e + this.host : this.hostname && (s = e + (-1 === this.hostname.indexOf(":") ? this.hostname : "[" + this.hostname + "]"), this.port && (s += ":" + this.port)), this.query && r.isObject(this.query) && Object.keys(this.query).length && (o = k.stringify(this.query));
        var a = this.search || o && "?" + o || "";
        return t && ":" !== t.substr(-1) && (t += ":"), this.slashes || (!t || y[t]) && !1 !== s ? (s = "//" + (s || ""), n && "/" !== n.charAt(0) && (n = "/" + n)) : s || (s = ""), i && "#" !== i.charAt(0) && (i = "#" + i), a && "?" !== a.charAt(0) && (a = "?" + a), t + s + (n = n.replace(/[?#]/g, (function(e) {
    ...
    (function(e, i) {
        ...
        ! function(s) {
            ...
            function T(e) {
                ...
                for (r = n > 0 ? n + 1 : 0; r < g;) {
                    for (s = y, o = 1, a = l; r >= g && m("invalid-input"), ((h = b(e.charCodeAt(r++))) >= l || h > p((c - y) / o)) && m("overflow"), y += h * o, !(h < (u = a <= v ? 1 : a >= v + 26 ? 26 : a - v)); a += l) o > p(c / (f = l - u)) && m("overflow"), o *= f;
            ...
            function I(e) {
                var t, n, i, r, s, o, a, h, u, f, d, y, k, w, b, T = [];
                for (y = (e = v(e)).length, t = 128, n = 0, s = 72, o = 0; o < y; ++o)(d = e[o]) < 128 && T.push(g(d));
                for (i = r = T.length, r && T.push("-"); i < y;) {
                    for (a = c, o = 0; o < y; ++o)(d = e[o]) >= t && d < a && (a = d);
                    for (a - t > p((c - n) / (k = i + 1)) && m("overflow"), n += (a - t) * k, t = a, o = 0; o < y; ++o)
                        if ((d = e[o]) < t && ++n > c && m("overflow"), d == t) {
    ...
    e.exports = function(e, t, n, s) {
        ...
        c > 0 && l > c && (l = c);
        for (var h = 0; h < l; ++h) {
            var u, f, d, p, g = e[h].replace(a, "%20"),
                m = g.indexOf(n);
            m >= 0 ? (u = g.substr(0, m), f = g.substr(m + 1)) : (u = g, f = ""), d = decodeURIComponent(u), p = decodeURIComponent(f), i(o, d) ? r(o[d]) ? o[d].push(p) : o[d] = [o[d], p] : o[d] = p
        }
        return o
    };
    ...
    ! function() {
        var t = n(68),
            ...
            o = function(e, n) {
                ...
                for (var a = t.bytesToWords(e), c = 8 * e.length, l = 1732584193, h = -271733879, u = -1732584194, f = 271733878, d = 0; d < a.length; d++) a[d] = 16711935 & (a[d] << 8 | a[d] >>> 24) | 4278255360 & (a[d] << 24 | a[d] >>> 8);
                ...
                for (d = 0; d < a.length; d += 16) {
                    var k = l,
                        ...
                        w = u,
                        b = f;
                    h = y(h = y(h = y(h = y(h = m(h = m(h = m(h = m(h = g(h = g(h = g(h = g(h = p(h = p(h = p(h = p(h, u = p(u, f = p(f, l = p(l, h, u, f, a[d + 0], 7, -680876936), h, u, a[d + 1], 12, -389564586), l, h, a[d + 2], 17, 606105819), f, l, a[d + 3], 22, -1044525330), u = p(u, f = p(f, l = p(l, h, u, f, a[d + 4], 7, -176418897), h, u, a[d + 5], 12, 1200080426), l, h, a[d + 6], 17, -1473231341), f, l, a[d + 7], 22, -45705983), u = p(u, f = p(f, l = p(l, h, u, f, a[d + 8], 7, 1770035416), h, u, a[d + 9], 12, -1958414417), l, h, a[d + 10], 17, -42063), f, l, a[d + 11], 22, -1990404162), u = p(u, f = p(f, l = p(l, h, u, f, a[d + 12], 7, 1804603682), h, u, a[d + 13], 12, -40341101), l, h, a[d + 14], 17, -1502002290), f, l, a[d + 15], 22, 1236535329), u = g(u, f = g(f, l = g(l, h, u, f, a[d + 1], 5, -165796510), h, u, a[d + 6], 9, -1069501632), l, h, a[d + 11], 14, 643717713), f, l, a[d + 0], 20, -373897302), u = g(u, f = g(f, l = g(l, h, u, f, a[d + 5], 5, -701558691), h, u, a[d + 10], 9, 38016083), l, h, a[d + 15], 14, -660478335), f, l, a[d + 4], 20, -405537848), u = g(u, f = g(f, l = g(l, h, u, f, a[d + 9], 5, 568446438), h, u, a[d + 14], 9, -1019803690), l, h, a[d + 3], 14, -187363961), f, l, a[d + 8], 20, 1163531501), u = g(u, f = g(f, l = g(l, h, u, f, a[d + 13], 5, -1444681467), h, u, a[d + 2], 9, -51403784), l, h, a[d + 7], 14, 1735328473), f, l, a[d + 12], 20, -1926607734), u = m(u, f = m(f, l = m(l, h, u, f, a[d + 5], 4, -378558), h, u, a[d + 8], 11, -2022574463), l, h, a[d + 11], 16, 1839030562), f, l, a[d + 14], 23, -35309556), u = m(u, f = m(f, l = m(l, h, u, f, a[d + 1], 4, -1530992060), h, u, a[d + 4], 11, 1272893353), l, h, a[d + 7], 16, -155497632), f, l, a[d + 10], 23, -1094730640), u = m(u, f = m(f, l = m(l, h, u, f, a[d + 13], 4, 681279174), h, u, a[d + 0], 11, -358537222), l, h, a[d + 3], 16, -722521979), f, l, a[d + 6], 23, 76029189), u = m(u, f = m(f, l = m(l, h, u, f, a[d + 9], 4, -640364487), h, u, a[d + 12], 11, -421815835), l, h, a[d + 15], 16, 530742520), f, l, a[d + 2], 23, -995338651), u = y(u, f = y(f, l = y(l, h, u, f, a[d + 0], 6, -198630844), h, u, a[d + 7], 10, 1126891415), l, h, a[d + 14], 15, -1416354905), f, l, a[d + 5], 21, -57434055), u = y(u, f = y(f, l = y(l, h, u, f, a[d + 12], 6, 1700485571), h, u, a[d + 3], 10, -1894986606), l, h, a[d + 10], 15, -1051523), f, l, a[d + 1], 21, -2054922799), u = y(u, f = y(f, l = y(l, h, u, f, a[d + 8], 6, 1873313359), h, u, a[d + 15], 10, -30611744), l, h, a[d + 6], 15, -1560198380), f, l, a[d + 13], 21, 1309151649), u = y(u, f = y(f, l = y(l, h, u, f, a[d + 4], 6, -145523070), h, u, a[d + 11], 10, -1120210379), l, h, a[d + 2], 15, 718787259), f, l, a[d + 9], 21, -343485551), l = l + k >>> 0, h = h + v >>> 0, u = u + w >>> 0, f = f + b >>> 0
                }
                return t.endian([l, h, u, f])
            };
        o._ff = function(e, t, n, i, r, s, o) {
            var a = e + (t & n | ~t & i) + (r >>> 0) + o;
            return (a << s | a >>> 32 - s) + t
        }, o._gg = function(e, t, n, i, r, s, o) {
            var a = e + (t & i | n & ~i) + (r >>> 0) + o;
            return (a << s | a >>> 32 - s) + t
        }, o._hh = function(e, t, n, i, r, s, o) {
            var a = e + (t ^ n ^ i) + (r >>> 0) + o;
            return (a << s | a >>> 32 - s) + t
        }, o._ii = function(e, t, n, i, r, s, o) {
            var a = e + (n ^ (t | ~i)) + (r >>> 0) + o;
            return (a << s | a >>> 32 - s) + t
    ...
    e.exports = function(e, t, n, i, r, s, o, a, c) {
        this.aiTypes = [{
            ...
            return d || (d = new t(e.length, r, n, i, o, s, a, c), e.push(d)), d.init(l, h, u, f, this.aiTypes[f]), d
        }
    }
}, function(e, t) {
    var n = 2 * Math.PI;
    e.exports = function(e, t, i, r, s, o, a, c) {
        this.sid = e, this.isAI = !0, this.nameIndex = s.randInt(0, o.cowNames.length - 1), this.init = function(e, t, n, i, r) {
        ...
        this.update = function(e) {
            if (this.active) {
                ...
                var P = this.scale;
                this.x - P < 0 ? (this.x = P, this.xVel = 0) : this.x + P > o.mapScale && (this.x = o.mapScale - P, this.xVel = 0), this.y - P < 0 ? (this.y = P, this.yVel = 0) : this.y + P > o.mapScale && (this.y = o.mapScale - P, this.yVel = 0)
            }
        }, this.canSee = function(e) {
            if (!e) return !1;
            if (e.skin && e.skin.invisTimer && e.noMovTimer >= e.skin.invisTimer) return !1;
        ...
        var h = 0,
            u = 0;
        this.animate = function(e) {
            this.animTime > 0 && (this.animTime -= e, this.animTime <= 0 ? (this.animTime = 0, this.dirPlus = 0, h = 0, u = 0) : 0 == u ? (h += e / (this.animSpeed * o.hitReturnRatio), this.dirPlus = s.lerp(0, this.targetAngle, Math.min(1, h)), h >= 1 && (h = 1, u = 1)) : (h -= e / (this.animSpeed * (1 - o.hitReturnRatio)), this.dirPlus = s.lerp(0, this.targetAngle, Math.max(0, h))))
